...
STRINGS: dict[str, dict[str, str]] = {
    ...
    "left.m":           {"ko": "{m}분",         "en": "{m}m"},
    "left.d":           {"ko": "{d}일 {h}시간",  "en": "{d}d {h}h"},
    "left.now":         {"ko": "곧 초기화",      "en": "resetting"},
    ...
    # --- tray ---
    "pet.today":        {"ko": "오늘  {tokens}  ·  ${cost}",
                         "en": "Today  {tokens}  ·  ${cost}"},
    "pet.block":        {"ko": "5시간 구간  {pct}%  ·  {left} 남음",
                         "en": "5-hour window  {pct}%  ·  {left} left"},
    "pet.week":         {"ko": "최근 7일  {pct}%",  "en": "Last 7 days  {pct}%"},
    "pet.companion":    {"ko": "{who}  —  {done} / {goal}",
                         "en": "{who}  —  {done} / {goal}"},
    "pet.pinned":       {"ko": "  (고정됨)",  "en": "  (pinned)"},
    "pet.unpin":        {"ko": "고정 해제",   "en": "Unpin"},
    "pet.hide":         {"ko": "펫 숨기기",   "en": "Hide pet"},
    "alert.block_full": {"ko": "5시간 예산을 다 썼어요!",
                         "en": "The 5-hour window is full!"},
